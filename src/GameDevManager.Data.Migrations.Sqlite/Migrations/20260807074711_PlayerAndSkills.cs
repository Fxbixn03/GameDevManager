    ...
    public partial class PlayerAndSkills : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    SkillTreeId = table.Column<Guid>(type: "TEXT", nullable: true),
                    ParentSkillId = table.Column<Guid>(type: "TEXT", nullable: true),
                    CostPoints = table.Column<double>(type: "REAL", nullable: true),
                    CostItemId = table.Column<Guid>(type: "TEXT", nullable: true),
                    CostItemAmount = table.Column<int>(type: "INTEGER", nullable: true),
                    GameProjectId = table.Column<Guid>(type: "TEXT", nullable: false),
