        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HealthFieldId = table.Column<Guid>(type: "TEXT", nullable: true),
                    DamageFieldId = table.Column<Guid>(type: "TEXT", nullable: true),
                    DefenseFieldId = table.Column<Guid>(type: "TEXT", nullable: true),
                    SpeedFieldId = table.Column<Guid>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
