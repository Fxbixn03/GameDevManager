        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HealthFieldId = table.Column<Guid>(type: "uuid", nullable: true),
                    DamageFieldId = table.Column<Guid>(type: "uuid", nullable: true),
                    DefenseFieldId = table.Column<Guid>(type: "uuid", nullable: true),
                    SpeedFieldId = table.Column<Guid>(type: "uuid", nullable: true)
                },
                constraints: table =>
                {
