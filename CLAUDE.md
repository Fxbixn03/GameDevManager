...
Was man beim Weiterarbeiten an den neuen Teilen wissen muss — die Migration dazu heißt in allen vier Providern `NpcRelationsMapLayersStoryAndBoards` (danach kam `FieldTagList` für die Stichwortfelder), die `FormatVersion` des Exports steht inzwischen auf **12**:
